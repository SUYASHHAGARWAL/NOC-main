...
# path('offerupload/', offer_upload_view, name='upload_offer_letter'),
    ...
    re_path(r'^api/Exit_surveySubmit',views.ExitSurveySubmit),
    ...
    re_path(r'^api/accndapliedstudents',views.NoDuesAccAppliedstudent),
    ...
    re_path(r'^api/AdminApprovedAllApps',views.AdminApprovedAllApps),
    re_path(r'^api/AdminDeclinedAllApps',views.AdminDeclinedAllApps),
